...
@check(
    ...
    rationale = """
        Stylistic sets must provide description text. Programs such as InDesign, TextEdit, Inkscape use that info to display to the users so that they know what a given stylistic set offers.
    """,
    misc_metadata = {
        ...
        for record in range(ttFont['GSUB'].table.FeatureList.FeatureCount):
            ...
            if tag in SSETS:
                if feature.Feature.FeatureParams == None:
                    ...
                    # TODO: maybe here we can add code to make sure that the referenced nameid does exist in the name table.
                break
